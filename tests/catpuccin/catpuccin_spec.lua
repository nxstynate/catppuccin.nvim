require("plenary.reload").reload_module("catpuccin", true)
local catpuccin = require("catpuccin")
local default = catpuccin.config

describe("setup", function()
  it("works with default values", function()
    catpuccin.setup()
    assert.are.same(catpuccin.config, default)
  end)
  ...
  it("works with old italic values", function()
    ...
    catpuccin.setup({ italic = true })
    assert.are.same(catpuccin.config, expected)
  end)
  ...
  it("works with config overrides", function()
    ...
    catpuccin.setup({ undercurl = false, underline = false })
    assert.are.same(catpuccin.config, expected)
  end)
end)
